  ...
  fighters: {
    ...
    roster: [
      ...
      { name: 'Kiwi Slasher', juice: 0x7bbf3a, finisher: 'SHREDDED!',
        tag: 'Speed demon', gait: { hop: 0.10, waddle: 0.16, squash: 0.14, freq: 14, wobble: 0.45 },
        stats: { hp: 170, speed: 8.6, attackCd: 0.24, reach: 3.2, damage: 14 } },
      { name: 'Coco Crusher', juice: 0x7a5536, bodyR: 0.92, finisher: 'CRACKED!',
        tag: 'Juggernaut', gait: { hop: 0.07, waddle: 0.20, squash: 0.10, freq: 5, lean: 0.04, wobble: 0.25, stomp: 1.0 },
