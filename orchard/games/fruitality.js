  ...
  fighters: {
    ...
    roster: [
      ...
      { name: 'Pineapple Punisher', juice: 0xf0a81e, finisher: 'PULPED!',
        tag: 'Heavy hitter', model: 'assets/models/pineapple.glb', gait: { hop: 0.08, waddle: 0.05, squash: 0.08, freq: 8, lean: 0.05, wobble: 0.18 },
        stats: { hp: 200, speed: 6.2, attackCd: 0.40, reach: 3.9, damage: 28 } },
      { name: 'Kiwi Slasher', juice: 0x7bbf3a, finisher: 'SHREDDED!',
        tag: 'Speed demon', model: 'assets/models/kiwi.glb', gait: { hop: 0.10, waddle: 0.16, squash: 0.14, freq: 14, wobble: 0.45 },
        stats: { hp: 170, speed: 8.6, attackCd: 0.24, reach: 3.2, damage: 14 } },
      { name: 'Coco Crusher', juice: 0x7a5536, bodyR: 0.92, finisher: 'CRACKED!',
        tag: 'Juggernaut', model: 'assets/models/coconut.glb', gait: { hop: 0.07, waddle: 0.20, squash: 0.10, freq: 5, lean: 0.04, wobble: 0.25, stomp: 1.0 },
        stats: { hp: 320, speed: 5.6, attackCd: 0.46, reach: 3.6, damage: 24 } },
    ],
    enemies: {
      banana: {
        name: 'Banana Berserker', juice: 0xf9d43a, scale: 0.95, model: 'assets/models/banana.glb',
        gait: { hop: 0.12, waddle: 0.30, squash: 0.18, freq: 7, wobble: 0.75 },
        stats: { hp: 50, speed: 3.0, attackCd: 1.7, reach: 1.9, damage: 6 },
      },
      grape: {
        name: 'Grape Goon', juice: 0x8a4fb0, scale: 0.7, model: 'assets/models/grape.glb',
        gait: { hop: 0.18, waddle: 0.10, squash: 0.18, freq: 15, wobble: 0.5 },
        stats: { hp: 30, speed: 4.3, attackCd: 1.3, reach: 1.6, damage: 5 },
      },
      lime: {
        name: 'Lime Brute', juice: 0x7bc74d, scale: 1.15, model: 'assets/models/lime.glb',
        gait: { hop: 0.10, waddle: 0.14, squash: 0.24, freq: 6.5, wobble: 0.4, stomp: 1.0 },
        stats: { hp: 90, speed: 2.5, attackCd: 2.0, reach: 2.1, damage: 9 },
      },
      coconut: {
        name: 'Coconut Titan', juice: 0x7a5536, scale: 1.9, bodyR: 1.15, model: 'assets/models/coconut.glb',
